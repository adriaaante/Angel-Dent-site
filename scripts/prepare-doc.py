...
WM_MODE = 'tint'      # знак перекрашиваем в один цвет — родной бледно-голубой теряется на бумаге
WM_BRAND = (30, 95, 179)      # фирменный синий #1E5FB3
WM_RATIO = 0.15      # сторона знака как доля короткой стороны скана
WM_MARGIN = 0.032       # отступ от края — тоже от короткой стороны
WM_OPACITY_DARK = 0.60  # тёмный знак на светлом документе
WM_OPACITY_LIGHT = 0.72 # белый знак на тёмном (бывают чёрные сертификаты)
