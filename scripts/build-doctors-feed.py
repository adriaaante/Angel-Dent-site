...
SHOP = {
    ...
    'url': 'https://angel-denta.ru/',
    'picture': 'https://angel-denta.ru/assets/img/logo.png',
    'email': 'angel.dent@bk.ru',
}

CLINIC = {
    'name': 'Стоматология «Ангел-Дент»',
    'url': 'https://angel-denta.ru/',
    'picture': 'https://angel-denta.ru/assets/img/logo.png',
    'city': 'г. Реутов',
    'address': 'Московская область, г. Реутов, ул. Победы, д. 22',
    'email': 'angel.dent@bk.ru',
    'phone': '+79104588808',
    'company_id': '1155929397',   # карточка Яндекса (yandex.ru/profile/…)
}

# Цену заявляем ТОЛЬКО там, где она дословно стоит на сайте (check_price).
# У хирургов и ортопеда отдельной строки «консультация» в прайсе Ангела
# нет — их офферы идут без цены, это допустимо (price не обязателен).
DOCTORS = [
    {'slug': 'drobkova', 'name': 'Дробкова Кристина Олеговна',
     'speciality': 'стоматолог-ортодонт',
     'description': 'Главный врач, стоматолог-ортодонт. Брекеты, элайнеры, исправление прикуса у взрослых и подростков.',
     'service': ('konsultaciya-ortodonta', 'Первичная консультация ортодонта'),
     'price': 0,
     'check_price': ('services/ortodontiya.html', 'Первичная консультация ортодонта')},
    {'slug': 'geworkyan', 'name': 'Геворкян Санатрук Иванович',
     'speciality': 'стоматолог-хирург',
     'description': 'Стоматолог-хирург, имплантолог. Удаление зубов, дентальная имплантация.',
     'service': ('priyom-hirurga', 'Приём стоматолога-хирурга')},
    {'slug': 'rustamli', 'name': 'Рустамли Руслан Рустамович',
     'speciality': 'стоматолог-хирург',
     'description': 'Стоматолог-хирург, имплантолог. Удаление зубов любой сложности, имплантация.',
     'service': ('priyom-hirurga', 'Приём стоматолога-хирурга')},
    {'slug': 'rustamov', 'name': 'Рустамов Эмиль Дилгамович',
     'speciality': 'стоматолог-ортопед',
     'description': 'Стоматолог-ортопед. Протезирование зубов: коронки, виниры, протезы на имплантах.',
     'service': ('priyom-ortopeda', 'Приём стоматолога-ортопеда')},
]

# Страницы врачей, осознанно НЕ включённые в фид (тематика допускает
# только врачей с высшим медицинским образованием).
# Кузьминов и Гущина в фид не идут: тематика DOCTORS — про приём пациентов,
# а они обеспечивают приём (описание снимков и стерилизация), сами не ведут.
EXCLUDE = {
    'kuzminov': 'врач-рентгенолог: описывает снимки для лечащих врачей, приём не ведёт',
    'gushchina': 'старшая медицинская сестра, не врач',
}
