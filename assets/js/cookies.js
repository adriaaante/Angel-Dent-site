...
(function () {
  ...
  function buildBanner() {
    ...
    wrap.innerHTML = ''
      ...
      +     'Пользуясь сайтом, вы соглашаетесь на cookies и Яндекс.Метрику — так сайт работает '
      +     'корректно. Подробнее: <a href="' + linkPath('cookies.html') + '">Cookie-политика</a>, '
      +     '<a href="' + linkPath('privacy.html') + '">конфиденциальность</a>.'
      +   '</div>'
