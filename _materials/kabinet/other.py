...
ITEMS = {
    'angel': [
        ...
        ('Документы для пациентов — комплект клиники',
         '35 бланков под ПП РФ № 659 (действуют с 01.09.2026), приказ Минздрава '
         '№ 1051н и 152-ФЗ: договор, ИДС, медкарта 043/у, согласия и отказы, план '
         'лечения, акт с гарантийным талоном, памятки, бланки на случай претензии, '
         'локальные акты и пакет по персональным данным. Бланки общие для трёх '
         'клиник — различаются только адрес, телефон и почта в шапке. Страница '
         '«когда какой документ подписывается» лежит и внутри архива, там у каждого '
         'бланка кнопка скачивания и шесть готовых комплектов для печати.',
         [],
         [('Весь пакет (ZIP)', '_materials/dogovor-pacienta/Документы-клиники.zip'),
          ('Когда какой документ (страница)', '_materials/dogovor-pacienta/Документы-клиники.html')]),
    ...
    'venecia': [
        ('QR-код на отзыв в Яндексе',
         'Ведёт на отзывы в карточке клиники (yandex.ru/profile/104110939502). '
         'Табличка A6 — на стойку ресепшена, чистый код — для визиток и наклеек. '
         'Отзывов пока нет, и первые особенно важны: карточка без них проигрывает '
         'соседям в выдаче Карт.',
         ['_materials/qr/qr-otziv-card-preview.jpg', '_materials/qr/qr-otziv-plain.png'],
         [('Табличка A6 (PDF)', '_materials/qr/qr-otziv-card-A6.pdf')]),
        ('Паспорт имплантов',
