...
ITEMS = {
    'angel': [
        ...
        ('QR-код на отзыв в Яндексе',
         'Ведёт прямо на форму отзыва в карточке клиники. Печатать на ресепшене '
         'и на карточке-памятке: отзывы — главный фактор локального ранжирования.',
         ['_materials/seo/qr-otziv-yandex.png'], []),
        ('Прайс для кабинета',
