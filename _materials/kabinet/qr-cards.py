...
⚠️ QR ведёт на реальную карточку клиники — id организации виден в коде
карты, который кабинет Яндекс.Бизнеса даёт для вставки на сайт
(«О компании» → «Карта на сайт», параметр `oid`). Так найден id
«Венеции» — 104110939502.
...
CLINICS = {
    ...
    'venecia': dict(
        ...
        codes=[('otziv', 'Оцените нас\nна Яндексе',
                'https://yandex.ru/profile/104110939502/reviews')]),
}
