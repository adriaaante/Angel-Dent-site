...
def build_docx() -> Path:
    ...
    for line in ("Ф. И. О. ______________________________________________",
                 ...
                 "Иной адрес для ответов на письменные обращения ________________",
    ...
    p(doc, "ПАЦИЕНТ — потребитель услуг (заполняется, если Пациент и Заказчик — "
           "разные лица)", bold=True, align="left", space=2)
    for line in ("Ф. И. О. ______________________________________________",
                 "Дата рождения ____________________",
                 "Паспорт: серия ______ № ______________ выдан ____________________",
                 "________________________________ дата выдачи ____________________",
                 ...
                 "(свидетельство о рождении, акт органа опеки, доверенность):",
