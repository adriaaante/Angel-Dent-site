...
Публикация = текст ≤3000 симв. (пишем 700–1200: хук на боль/желание в
первом предложении, списки, соцдоказательство «5,0 / 200+ оценок» без
точных счётчиков, ключевые слова услуг + «Реутов»/«Новокосино», в конце
дисклеймер «Имеются противопоказания…») + **карусель 3–4 картинок**:
1-я — бренд-обложка **1800×960** full-bleed БЕЗ цен (заголовок +
подзаголовок золотом + лого-чип), 2–4-я — «живые» фото по теме с водяным
знаком клиники (переиспользуем библиотеку акций/витрины/сторис; цены
живут в «Акциях», посты = контент). Скрипт картинок —
`_materials/yb-promo/posts-build.py`. Правила людей/зачистки надписей —
как у акций. **Самая свежая публикация показывается первой** → «горячую»
тему заливать последней. Публиковать регулярно (мин. раз в месяц) —
влияет на локальное ранжирование. Реестр — таблица «Публикации ЯБ» в
`_materials/yb-stories/REGISTRY.md`; тексты — google-doc
«Публикации ЯБ — ИТОГ» в папке Drive «Публикации ЯБ»
(1uNvT17QY9SvZZezSxUt333UO9yin9yeO).
