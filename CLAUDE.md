...
(врачи — assets/img/doctors: фирменные карточки с ФИО/специализацией/
стажем + командный коллаж; интерьеры — assets/img/generated/
clinic-real-*.webp: кабинет, ресепшн с вывеской, зона ожидания) —
доверие выше, людей ищут по имени; сгенерированные фото — только для
...
google-doc «Публикации ЯБ — ИТОГ v8 бренд-стиль» в папке Drive
