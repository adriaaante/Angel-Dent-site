...
**Публикации = НОВОСТИ клиники** (уточнение владельца): каждая —
инфоповод, первое предложение в новостном тоне («теперь», «запустили»,
«напоминаем», «показываем»), не вечнозелёные статьи. Темы чередуем:
знакомство с клиникой / сезонная профилактика / бесплатные консультации /
приём с острой болью / оффер. Однотипные баннеры НЕ делаем —
...
google-doc «Публикации ЯБ — ИТОГ v6 НОВОСТИ» в папке Drive
