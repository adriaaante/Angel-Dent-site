...
до 4 картинок, обычно 3–4). **Врачи и клиника — РЕАЛЬНЫЕ фото с сайта**
(assets/img/doctors): фирменные карточки врачей с ФИО/специализацией/
стажем и командный коллаж — доверие выше, людей ищут по имени;
сгенерированные фото — только для сцен, которых нет в реальных
материалах (пациенты, lifestyle). Тексты ≤3000 симв. (пишем 700–1200): хук на
...
google-doc «Публикации ЯБ — ИТОГ v4 с реальными врачами» в папке Drive
