...
Публикация = текст ≤3000 симв. (пишем 500–800: суть в первом предложении,
списки, ключевые слова услуг + «Реутов»/«Новокосино», в конце дисклеймер
«Имеются противопоказания…») + 1 картинка **1800×960** в бренд-стиле
full-bleed, но БЕЗ цен — заголовок + подзаголовок золотом + лого-чип
(цены живут в «Акциях», посты = контент). Скрипт картинок —
